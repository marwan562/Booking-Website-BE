...
export const uploadSingleFile = (fieldName) => getMulterInstance().single(fieldName);

export const uploadMixfile = (arrayOfFields) => getMulterInstance().fields(arrayOfFields);

              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td align="center" style="padding: 8px 24px 24px 24px;">
                    <a href="${BASE_URL}/auth/verify-email/${id}" style="display: inline-block; background-color: #ff0066; color: #ffffff; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 600; text-decoration: none; padding: 12px 24px; border-radius: 8px; box-shadow: 0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px -1px rgba(0,0,0,0.1);">
                      Verify Email
                    </a>
                  ...
                  <td style="padding: 0 24px 24px 24px;">
                    <div style="background-color: #ede9de; border-radius: 8px; padding: 16px;">
                      <p style="margin: 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; color: #535146;">
                        <strong style="color: #141413;">Didn't create an account?</strong><br>
